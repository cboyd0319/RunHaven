...
fn map_owned_wrapped_line_to_range(
    ...
    while let Some(ch) = chars.next() {
        ...
        // Could not fully map this owned line back to source bytes; return the
        // partial source range. (Codex logged this via tracing::warn!; that
        // logging coupling is removed in RunHaven.)
        break;
    }
