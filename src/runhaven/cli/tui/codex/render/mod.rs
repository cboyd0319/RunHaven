...
// Codex declared `pub(crate) mod highlight;` here. RunHaven does not vendor the
// syntax-highlighting engine (it pulls the heavy syntect + two_face bundles and
// is unrelated to the Renderable layout foundation), so it is omitted.
