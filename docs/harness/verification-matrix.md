...
| Worktree run isolation | Python code checks plus focused standard-run tests for `--worktree` dry-run preview, clean-source enforcement, isolated mount, source checkout preservation, and run-record recovery metadata |
